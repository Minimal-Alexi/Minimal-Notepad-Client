        ...
        try {
            ...
            if (response.statusCode() == 200) {
                ...
                for (int i = 0; i < result.length(); i++) {
                    ...
                    Note note = new Note(noteJson.getString("title"), noteJson.getString("text"), noteJson.getString("colour"), "Product needs", "Kurnia Majid", "Hobby", noteJson.getString("createdAt") );
                    notes.add(note);
                }
                return notes;
            }
