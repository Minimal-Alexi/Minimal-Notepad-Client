...
//    public void setCellValue(TableColumn<Group, Integer> columnLabel, String groupIntProperty) {
//        columnLabel.setCellValueFactory(new PropertyValueFactory<>(groupIntProperty));
//    }
//
//    public void setCellValue(TableColumn<Group, String> columnLabel, String groupStringProperty) {
//        columnLabel.setCellValueFactory(new PropertyValueFactory<>(groupStringProperty));
//    }
...
////        getAllgroups();
//        GroupControllerUtils.getAllgroups(httpResponseService);
//        GroupControllerUtils.updateColumnOne(stage,actionOneCol);
//        GroupControllerUtils.updateColumnTwo(actionTwoCol, httpResponseService, this::handleJoinOrLeaveOrDeleteResponse)
////        updateColumnOne();
////        updateColumnTwo();
//    }
